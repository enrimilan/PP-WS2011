...
public class Bank {
	...
	*/
	public void deleteAccount(String accountID) throws AccountIsDeleteProtectedException,NoSuchElementException {
		...
		if(account.isProtected()) {
			throw new AccountIsDeleteProtectedException("Account is protected");
		}
