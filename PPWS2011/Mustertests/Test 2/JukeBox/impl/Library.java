...
public class Library {
	...
	private HashMap<String , Playlist> bib;
	...
	*/
	public Library() {
		...
		bib=new HashMap<String , Playlist>();
	...
	*/
	public Library(Library libraryToImport, String[] listOfNames) {
		...
		for(int i = 0 ; i<listOfNames.length;i++){
			addPlaylist(listOfNames[i],new Playlist(libraryToImport.getPlaylist(listOfNames[i])));
		}
	...
	*/
	public void addPlaylist(String name, Playlist playlist) {
		...
		if(bib.containsKey(name)){
                	removePlaylist(name);
                	bib.put(name , playlist);
                }
                else{
                	bib.put(name , playlist);
		}
